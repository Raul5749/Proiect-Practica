    ...
    <div class="container mt-5" style="max-width: 800px;">
        ...
        <div class="card border-secondary mb-5" style="background-color: #1f1f1f;">
            <div class="card-body text-center">
                ...
                <p class="card-text" style="color: #6f42c1;"><strong>Nume utilizator:</strong> <?php echo htmlspecialchars($utilizator['USERNAME']); ?></p>
                <p class="card-text mb-4" style="color: #6f42c1;"><strong>Email:</strong> <?php echo htmlspecialchars($utilizator['EMAIL']); ?></p>

                <a href="schimbare_parola.php" class="btn btn-outline-light mb-2">Schimbă parola</a>
                <a href="logout.php" class="btn btn-outline-light mb-2">Deconectare</a>
                <a href="proiect.php" class="btn btn-outline-light mb-2">Înapoi la magazin</a>
                
                <?php if (isset($_SESSION['ADMIN']) && $_SESSION['ADMIN'] == 1) { ?>
                    <a href="admin.php" class="btn btn-warning fw-bold mb-2">Panou Admin</a>
                <?php } ?>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php foreach ($comenzi as $c) { ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-warning text-dark"><?php echo $c['STATUS'] ?? 'Noua'; ?></span>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
